...
<template>
  <div
    class="relative sm:rounded-lg p-8 max-w-full w-screen md:max-w-full overflow-x-auto"
  >
    <table
    ...
    <div
      v-if="props.dataItems.data.length < 1"
      class="flex justify-center items-center bg-white p-4 py-8">
